            ...
            return (
              ...
              >
                ...
                <div className="min-w-0 flex-1 px-4 py-4">
                  <h2 className="font-serif text-lg font-black leading-tight text-white sm:text-xl">
                ...
                <div className="mr-4 shrink-0">
                  {locked ? (
                    <div className="grid h-12 w-12 place-items-center rounded-full border border-white/10 bg-black/25 text-white/50">
                      <Lock size={23} />
                    </div>
                  ) : completed ? (
                    <div className="grid h-12 w-12 place-items-center rounded-full border border-emerald-300/35 bg-emerald-500/20 text-emerald-300">
                      <Check size={25} strokeWidth={3} />
                    </div>
                  ) : (
                    <div className={`flex items-center gap-1 rounded-full border border-white/35 bg-gradient-to-r ${theme.button} px-4 py-2 text-xs font-black uppercase tracking-wider`}>
                      {t('Play', 'Jouer')}
