...
const GOOGLE_PLAY_URL = 'https://play.google.com/store/apps/details?id=com.belleus.myapp';
...
const copy = {
  ...
  fr: {
    ...
    company: 'Belleus Educational Games',
    location: 'Ottawa, Canada',
    getOnGooglePlay: 'Télécharger sur Google Play',
    description:
  ...
  ht: {
    title: 'Enfòmasyon',
    tagline: 'Twa verite ak yon manti',
    developedBy: 'Devlope pa',
    company: 'Belleus Educational Games',
    location: 'Ottawa, Kanada',
    getOnGooglePlay: 'Telechaje sou Google Play',
    description:
      "Bible Challenge se plis pase yon jwèt — se yon misyon pou ede moun toupatou dekouvri, aprann, epi sonje Pawòl Bondye a yon fason ki plèzan ak siyifikatif. Li fèt pou jwè nan tout laj, li konbine divertisман, defi, ak konesans biblik pou ranfòse lafwa ak konesans.",
    vision:
      "Depi premye vèsyon li, Bible Challenge disponib nan kat lang. Vizyon mwen se elaji li nan anpil lòt lang pou moun toupatou nan mond lan ka eksperimante Pawòl Bondye nan pwòp lang yo. Avèk ankourajman, kòmantè, ak sipò nou, ansanm nou ka fè vizyon sa a tounen reyalite.",
    version: 'Vèsyon 1.0.0',
    copyright: '© 2026 Belleus Educational Games',
    back: 'Retounen nan Paramèt',
  },
} as const;
        ...
        <div className="w-full rounded-3xl border border-white/20 bg-slate-950/35 p-7 shadow-2xl backdrop-blur-md sm:p-9">
          ...
          <div className="mt-7">
            <a
              ...
              className="inline-flex items-center gap-3 rounded-2xl border border-white/20 bg-slate-900/70 px-5 py-3 shadow-lg transition-opacity hover:opacity-80"
              aria-label={text.getOnGooglePlay}
            >
              {/* Google Play triangle logo */}
              <svg viewBox="0 0 24 24" className="h-6 w-6 shrink-0" aria-hidden="true">
                <path fill="#4CAF50" d="M1.22 0a1.22 1.22 0 0 0-1.22 1.22v21.56a1.22 1.22 0 0 0 1.22 1.22l.12-.01L13.41 12 1.34.01.22 0z"/>
                <path fill="#FFC107" d="M17.39 8.27 4.06.3l10.76 10.76 2.57-2.79z"/>
                <path fill="#FF3D00" d="M.37 23.47c.21.2.5.33.83.33l.12-.01 13.09-13.11L12.65 9z"/>
                <path fill="#4CAF50" d="M17.39 15.73l-2.74-2.74-1.01 1.01 3.14 1.73z"/>
                <path fill="#FFC107" d="M4.06 23.7l13.33-7.97-2.57-2.78z"/>
              </svg>
              <div className="text-left">
                <p className="text-xs text-white/50 leading-none">Google Play</p>
                <p className="mt-0.5 font-serif text-sm font-bold text-white leading-tight">
                  {text.getOnGooglePlay}
                </p>
              </div>
            </a>
          </div>
